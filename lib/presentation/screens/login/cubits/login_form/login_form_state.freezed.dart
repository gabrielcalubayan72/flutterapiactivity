...
class _$LoginFormStateImpl implements _LoginFormState {
  const _$LoginFormStateImpl({this.username = '', this.password = ''});
  ...
  @override
  String toString() {
    return 'LoginFormState(username: $username, password: $password)';
  }
...
abstract class _LoginFormState implements LoginFormState {
  const factory _LoginFormState(
      {final String username, final String password}) = _$LoginFormStateImpl;
